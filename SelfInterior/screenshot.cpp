...
Screenshot::Screenshot(int startX, int startY, int endX, int endY)
    :  screenshotLabel(new QLabel(this)),mStartX(startX),mStartY(startY),mEndX(endX),mEndY(endY)
{
...
void Screenshot::shootScreen()
{
    ...
    //TODO select Area from user
    originalPixmap = screen->grabWindow(0,mStartX+10,mStartY+10,width,height);
    updateScreenshotLabel();
